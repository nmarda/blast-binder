...
This tutorial assumes that you have an account with Google Cloud Platform (GCP), as well as familiarity with its basic tools. If you do not, please see our [GCP tutorial](/~/tutorial_gcp/).
...
## Using BLAST+ Docker Image at Production Scale
